...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		ActionListener sizeChanged = new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				MainFrame.this.drawing.setStroke(new BasicStroke(MainFrame.this.sizePixel, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER));
				updateToolLabel();
			}
		};
		...
		this.paint = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				g2.setStroke(new BasicStroke(MainFrame.this.sizePixel, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER));
	...
	private void newCanvas(boolean keepCont) {
		...
		newG.setStroke(new BasicStroke(this.sizePixel, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER));
	...
	private void updateToolLabel() {
		this.tool.setText("工具 : " + this.mode.getSelectedItem() +
				(this.fill.isSelected() ? " , 填滿" :" , 筆刷大小 : " + getSizeText()) );
	}
